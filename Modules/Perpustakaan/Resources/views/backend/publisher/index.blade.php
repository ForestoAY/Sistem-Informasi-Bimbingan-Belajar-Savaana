                                        ...
                                        <tbody>
                                            @foreach ($publisher as $key => $publishers)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('publisher.edit', $publishers->id)}}" class="btn btn-warning btn-sm">Edit</a>
                                                        <a href="{{route('publisher.show', $publishers->id)}}" class="btn btn-info btn-sm">Detail</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
